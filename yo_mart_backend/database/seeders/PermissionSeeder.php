...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            // Dashboard
            ['name' => 'View Dashboard', 'route_web' => '/dashboard', 'code' => 'dashboard.view'],
            ...
            // Products
            ['name' => 'View Products', 'route_web' => '/product', 'code' => 'product.view'],
            ['name' => 'Create Product', 'route_web' => '/product', 'code' => 'product.create'],
            ['name' => 'Update Product', 'route_web' => '/product', 'code' => 'product.update'],
            ['name' => 'Delete Product', 'route_web' => '/product', 'code' => 'product.delete'],
        ...
        foreach ($permissions as $permission) {
            Permission::updateOrCreate(
                ...
                ['name' => $permission['name'], 'route_web' => $permission['route_web']]
            );
        }
    }
}
